...
public class exe{
/*
*находимдлинуключа,сравнива€индексысоответстви€выборокизтекстачерез/предполагаема€длинаключа/символов.
*наосновебольшоготекстовогофайлаузнаемчащевсеговстречающуюс€буквув€зыке
*
*/
	public static void main(String[] args) throws Exception {
		char[] alphabet={'а','б','в','г','д','е','ж','з','и','й','к','л','м','н','о','п','р','с','т','у','ф','х','ц','ч','ш','щ','ъ','ы','ь','э','ю','€'};
