...
public class MontRed_reference {
	/* 
	 ...
	 */
		...
		// Input parameter
		public BigInteger modulus;  // Must be an odd number at least 3
		
		// Computed numbers
		public BigInteger reducer;       // Is a power of 2
		public int reducerBits;          // Equal to log2(reducer)
		public BigInteger reciprocal;    // Equal to reducer^-1 mod modulus
		public BigInteger mask;          // Because x mod reducer = x & (reducer - 1)
		public BigInteger factor;        // Equal to (reducer * reducer^-1 - 1) / n
		public BigInteger convertedOne;  // Equal to convertIn(BigInteger.ONE)
		
		
		
		// The modulus must be an odd number at least 3
		public MontRed_reference(BigInteger modulus) {
			// Modulus
